...
class FineTuningDataset(Dataset):
    ...
    def __getitem__(self, index) :
        ...
        label_str = instance["summary_text"]
        
        decoder_input_ids = [self.tokenizer.eos_token_id]
        decoder_input_ids.extend(label_ids)
...
def collate_fn(batch) :
    ...
    for num, data in enumerate(batch) :
        ...
        label_strings.append(data["label_str"])

    return encoder_dict, decoder_dict, label_dict, label_strings
